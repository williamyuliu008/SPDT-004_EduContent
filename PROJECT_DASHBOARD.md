...
## 10. v3.0 拍板候选（详见 [PRODUCT_LINE.md v2.0 演化规则](PRODUCT_LINE.md)）

| 方向 | 内容 | 价值 | 估时 |
|:---|:---|:---|:---:|
| **A · 4 真产品闭环** | P-001 视频渲染管线（manim + 配音 + 字幕）| 100% 闭环 | 4-6 周 |
| **B · 跨学科扩展** | 英语（高考 3 大主科之一，需求最大）| 覆盖面 | 3-4 周 |
| **C · 持续运营深化** | autoclaw 自动化产卡接入 review_inbox | 持续生产 | 2-3 周 |
| **D · review_inbox 工具化** | lint / status / archive 自动检查 | 防漂移 | 1-2 周 |
