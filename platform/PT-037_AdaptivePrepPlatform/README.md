...
**物理位置**：`platform/PT-037_AdaptivePrepPlatform/`（从 products/ 移入，2026-07-29）

与 products/courses/ 的关系：课程包（书法备考/历史备考）提供**内容原料**（剧本/卡片/辨析卡），PT-037 负责**内容消费编排**（知识图谱 + 自适应训练调度）。
