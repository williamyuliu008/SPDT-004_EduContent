...
# 默认路径：本机 spdt-content-cards/历史/cards（mirror 来自另一台机器）
# 可通过命令行参数覆盖：python 07_validate.py <其他路径>
# 优先用相对仓路径，跨机兼容
BASE = Path(r"D:\Z_学习平台\spdt-content-cards\历史\cards")
CONCEPTS_PATH = Path(r"D:\Z_学习平台\spdt-content-cards\00-项目文档\_62_concepts.json")
